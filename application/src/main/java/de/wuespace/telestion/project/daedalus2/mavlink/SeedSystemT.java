...
public record SeedSystemT(
	...
	/**
	 * set point for the pitch angle for the servos<br>
	 * <br>
	 * <i>Autogenerated by XML2Record-Tool v1.3.11</i>
	 */
	@MavField(nativeType = NativeType.FLOAT)
	 ...
	 */
	@MavField(nativeType = NativeType.UINT_8)
	@JsonProperty short systemConfig,
	/**
	 ...
	 */
	@MavField(nativeType = NativeType.UINT_8)
	@JsonProperty short gpsSatsused,
	/**
	 * identifier for controller type/state<br>
	 * <br>
	 * <i>Autogenerated by XML2Record-Tool v1.3.11</i>
	 */
	@MavField(nativeType = NativeType.UINT_8)
	@JsonProperty short controllerId,
	/**
	 ...
	 */
	@MavField(nativeType = NativeType.UINT_8)
	@JsonProperty short availableStatus) implements MavlinkMessage {
	/**
	 * There shall be no default-constructor for normal developers.
	 */
	@SuppressWarnings("unused")
	private SeedSystemT() {
		this((long) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (float) 0, (short) 0, (byte) 0, (short) 0, (short) 0, (short) 0, (short) 0, (short) 0);
	}
}
