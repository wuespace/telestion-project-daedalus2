...
/**
 * High level message to control a gimbal's pitch and yaw angles. This message is to be sent to the gimbal manager (e
 * .g. from a ground station). Angles and rates can be set to NaN according to use case.
 */
public class msg_gimbal_manager_set_pitchyaw extends MAVLinkMessage {
	 ...
	 */
	public msg_gimbal_manager_set_pitchyaw(long flags,
			float pitch,
			float yaw,
			float pitch_rate,
			float yaw_rate,
