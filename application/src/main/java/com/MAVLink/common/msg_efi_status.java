...
public class msg_efi_status extends MAVLinkMessage {
	 ...
	 */
	public msg_efi_status(float ecu_index,
			float rpm,
			float fuel_consumed,
			float fuel_flow,
			float engine_load,
