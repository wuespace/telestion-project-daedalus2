...
/**
 * The RAW IMU readings for the usual 9DOF sensor setup. This message should contain the scaled values to the
 * described units
 */
public class msg_scaled_imu extends MAVLinkMessage {
	 ...
	 */
	public msg_scaled_imu(long time_boot_ms,
			short xacc,
			short yacc,
			short zacc,
			short xgyro,
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SCALED_IMU - sysid:" + sysid + " compid:" + compid + " time_boot_ms:" + time_boot_ms +
				" xacc:" + xacc + " yacc:" + yacc + " zacc:" + zacc + " xgyro:" + xgyro + " ygyro:" + ygyro + " zgyro" +
				":" + zgyro + " xmag:" + xmag + " ymag:" + ymag + " zmag:" + zmag + " temperature:" + temperature + "";
	}
