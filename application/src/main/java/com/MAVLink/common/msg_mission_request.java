 ...
 * message should be a MISSION_ITEM message. https://mavlink.io/en/services/mission.html
 */
public class msg_mission_request extends MAVLinkMessage {
	 ...
	 */
	public msg_mission_request(int seq,
			short target_system,
	...
	public String toString() {
		return "MAVLINK_MSG_ID_MISSION_REQUEST - sysid:" + sysid + " compid:" + compid + " seq:" + seq + " " +
