...
/**
 * The position the system will return to and land on. The position is set automatically by the system during the
 * takeoff in case it was not explicitly set by the operator before or after. The global and local positions encode
 * the position in the respective coordinate frames, while the q parameter encodes the orientation of the surface.
 * Under normal conditions it describes the heading and terrain slope, which can be used by the aircraft to adjust
 * the approach. The approach 3D vector describes the point to which the system should fly in normal flight mode and
...
public class msg_set_home_position extends MAVLinkMessage {
	 ...
	 */
	public msg_set_home_position(int latitude,
			int longitude,
			int altitude,
			float x,
			float y,
	...
	public String toString() {
		return "MAVLINK_MSG_ID_SET_HOME_POSITION - sysid:" + sysid + " compid:" + compid + " latitude:" + latitude +
				" longitude:" + longitude + " altitude:" + altitude + " x:" + x + " y:" + y + " z:" + z + " q:" + q +
				" approach_x:" + approach_x + " approach_y:" + approach_y + " approach_z:" + approach_z + " " +
				"target_system:" + target_system + " time_usec:" + time_usec + "";
	}
