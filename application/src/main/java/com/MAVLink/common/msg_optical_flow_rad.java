...
public class msg_optical_flow_rad extends MAVLinkMessage {
	...
	/**
	 * Flow around X axis (Sensor RH rotation about the X axis induces a positive flow. Sensor linear motion along the
	 * positive Y axis induces a negative flow.)
	 */
	public float integrated_x;

	/**
	 * Flow around Y axis (Sensor RH rotation about the Y axis induces a positive flow. Sensor linear motion along the
	 ...
	 */
	public msg_optical_flow_rad(long time_usec,
	...
	public String toString() {
		return "MAVLINK_MSG_ID_OPTICAL_FLOW_RAD - sysid:" + sysid + " compid:" + compid + " time_usec:" + time_usec +
