...
public class MAV_DATA_STREAM {
	...
	public static final int MAV_DATA_STREAM_RC_CHANNELS = 3; /* Enable RC_CHANNELS_SCALED, RC_CHANNELS_RAW,
	SERVO_OUTPUT_RAW | */
	public static final int MAV_DATA_STREAM_RAW_CONTROLLER = 4; /* Enable ATTITUDE_CONTROLLER_OUTPUT,
	POSITION_CONTROLLER_OUTPUT, NAV_CONTROLLER_OUTPUT. | */
	public static final int MAV_DATA_STREAM_POSITION = 6; /* Enable LOCAL_POSITION,
