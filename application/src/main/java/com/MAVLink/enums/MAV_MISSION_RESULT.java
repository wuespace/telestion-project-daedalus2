...
public class MAV_MISSION_RESULT {
	...
	public static final int MAV_MISSION_DENIED = 14; /* Not accepting any mission commands from this communication
	partner. | */
	public static final int MAV_MISSION_OPERATION_CANCELLED = 15; /* Current mission operation cancelled (e.g. mission
	 upload, mission download). | */
