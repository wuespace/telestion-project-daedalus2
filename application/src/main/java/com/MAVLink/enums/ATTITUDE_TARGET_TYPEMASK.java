...
/**
 * Bitmap to indicate which dimensions should be ignored by the vehicle: a value of 0b00000000 indicates that none of
...
public class ATTITUDE_TARGET_TYPEMASK {
	...
	public static final int ATTITUDE_TARGET_TYPEMASK_THRUST_BODY_SET = 32; /* Use 3D body thrust setpoint instead of
	throttle | */
