...
public class MAV_AUTOPILOT {
	...
	public static final int MAV_AUTOPILOT_ARDUPILOTMEGA = 3; /* ArduPilot - Plane/Copter/Rover/Sub/Tracker,
	https://ardupilot.org | */
	public static final int MAV_AUTOPILOT_OPENPILOT = 4; /* OpenPilot, http://openpilot.org | */
	public static final int MAV_AUTOPILOT_GENERIC_WAYPOINTS_ONLY = 5; /* Generic autopilot only supporting simple
	waypoints | */
	public static final int MAV_AUTOPILOT_GENERIC_WAYPOINTS_AND_SIMPLE_NAVIGATION_ONLY = 6; /* Generic autopilot
	supporting waypoints and other simple navigation commands | */
	public static final int MAV_AUTOPILOT_GENERIC_MISSION_FULL = 7; /* Generic autopilot supporting the full mission
	command set | */
