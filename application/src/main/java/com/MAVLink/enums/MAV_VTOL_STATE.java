...
public class MAV_VTOL_STATE {
	...
	public static final int MAV_VTOL_STATE_TRANSITION_TO_FW = 1; /* VTOL is in transition from multicopter to
	fixed-wing | */
	public static final int MAV_VTOL_STATE_TRANSITION_TO_MC = 2; /* VTOL is in transition from fixed-wing to
	multicopter | */
