...
public class msg_ejector_log extends MAVLinkMessage {
	...
	public static final int MAVLINK_MSG_ID_EJECTOR_LOG = 24017;
	 ...
	 */
	public msg_ejector_log(long time_local, long d2time, byte[] log_msg) {
		this.msgid = MAVLINK_MSG_ID_EJECTOR_LOG;
	 ...
	 */
	public msg_ejector_log(long time_local, long d2time, byte[] log_msg, int sysid, int compid, boolean isMavlink2) {
		this.msgid = MAVLINK_MSG_ID_EJECTOR_LOG;
		this.sysid = sysid;
		this.compid = compid;
