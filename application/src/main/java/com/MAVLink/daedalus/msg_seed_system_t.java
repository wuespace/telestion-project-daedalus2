...
public class msg_seed_system_t extends MAVLinkMessage {
     ...
     */
    public msg_seed_system_t( long time_local, long mainloop_itr_cnt, long mainloop_itr_time, float imu_acc_x, float imu_acc_y, float imu_acc_z, float imu_gyro_x, float imu_gyro_y, float imu_gyro_z, float baro_press, float baro_temp, float vacuum_baro_press, float tacho_rot_rate, float bat_temp, float gps_lat, float gps_long, float gps_hdop, float gps_alt, float filter_vel_vertical, float filter_height_ground, float filter_rotor_rot_rate, float fiter_body_rot_rate, float controller_blade_pitch, float controller_fin_angle, int[] adc_measurements_sbc, int[] adc_measurements_cop, short state_cur, short iridium_RSSI, short lidar_cover_open, short bat_heater_fault, short bat_allowed, short bat_used, short gps_quality, short gps_satsUsed, short blade_controller_id, short finn_controller_id, short available_status) {
        this.msgid = MAVLINK_MSG_ID_SEED_SYSTEM_T;
     ...
     */
    public msg_seed_system_t( long time_local, long mainloop_itr_cnt, long mainloop_itr_time, float imu_acc_x, float imu_acc_y, float imu_acc_z, float imu_gyro_x, float imu_gyro_y, float imu_gyro_z, float baro_press, float baro_temp, float vacuum_baro_press, float tacho_rot_rate, float bat_temp, float gps_lat, float gps_long, float gps_hdop, float gps_alt, float filter_vel_vertical, float filter_height_ground, float filter_rotor_rot_rate, float fiter_body_rot_rate, float controller_blade_pitch, float controller_fin_angle, int[] adc_measurements_sbc, int[] adc_measurements_cop, short state_cur, short iridium_RSSI, short lidar_cover_open, short bat_heater_fault, short bat_allowed, short bat_used, short gps_quality, short gps_satsUsed, short blade_controller_id, short finn_controller_id, short available_status, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_SEED_SYSTEM_T;
        this.sysid = sysid;
        this.compid = compid;
