...
public class msg_seed_heartbeat extends MAVLinkMessage {
     ...
     */
    public msg_seed_heartbeat( long time_local, float imu_gyro_z, int[] adc_measurements_cop, short state_cur, short lidar_cover_open, short bat_heater_fault, short available_status, short bat_allowed, short bat_used) {
        this.msgid = MAVLINK_MSG_ID_SEED_HEARTBEAT;
     ...
     */
    public msg_seed_heartbeat( long time_local, float imu_gyro_z, int[] adc_measurements_cop, short state_cur, short lidar_cover_open, short bat_heater_fault, short available_status, short bat_allowed, short bat_used, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_SEED_HEARTBEAT;
        this.sysid = sysid;
        this.compid = compid;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_SEED_HEARTBEAT - sysid:"+sysid+" compid:"+compid+" time_local:"+time_local+" imu_gyro_z:"+imu_gyro_z+" adc_measurements_cop:"+adc_measurements_cop+" state_cur:"+state_cur+" lidar_cover_open:"+lidar_cover_open+" bat_heater_fault:"+bat_heater_fault+" available_status:"+available_status+" bat_allowed:"+bat_allowed+" bat_used:"+bat_used+"";
    }
